...
void scope_variables(Stmts *tree) {
    ...
    scope_levels[0]["plane"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "plane", CONSTRUCTIONV, "ero_plane");
    scope_levels[0]["sphere"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "sphere", CONSTRUCTIONV, "ero_sphere");
    scope_levels[0]["line"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "line", CONSTRUCTIONV, "ero_line");
    scope_levels[0]["point"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "point", CONSTRUCTIONV, "ero_point");
    scope_levels[0]["intersection"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "intersection", CONSTRUCTIONV, "ero_intersection");
    scope_levels[0]["point_on"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "point_on", CONSTRUCTIONV, "ero_point_on");
    scope_levels[0]["center"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "center", CONSTRUCTIONV, "ero_center");
    scope_levels[0]["endpoints"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "endpoints", CONSTRUCTIONV, "ero_endpoints");
    scope_levels[0]["segment"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "segment", CONSTRUCTIONV, "ero_segment");
    scope_levels[0]["ray"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "ray", CONSTRUCTIONV, "ero_ray");
    scope_levels[0]["arc"] = data_counter;
    data_locs[data_counter++] = Data(DATA_SEGMENT, "arc", CONSTRUCTIONV, "ero_arc");
