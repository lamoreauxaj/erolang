...
int main(int argc, char **argv) {
    ...
    if (!res) {
        ...
        if (prod)
            ...
            command = "g++ -static -o " + output_file + " " + output_file + ".s ../src/lib/variable.cpp ../src/lib/geometry.cpp ../src/lib/geometry_wrappers.cpp ../src/lib/error.cpp ../src/lib/util.cpp";
